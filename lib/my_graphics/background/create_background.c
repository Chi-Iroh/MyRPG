...
{
    tmx_t * tmx = parser_tmx("images/csv_and_tmx/All.tmx"); needs_t needs;
    int ** background = parser_csv("./images/csv_and_tmx/map_Background.csv");
    int ** core = parser_csv("./images/csv_and_tmx/map_Core.csv");
